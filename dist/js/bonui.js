/**
 * BonUI 1.0.0
 * BonUI 百邦UI 集成了 jQuery 3.1+、Swiper 3.4+、fastclick 1.0 +, WeUI Css 1.1+
 * 
 * Copyright 2017, Adolf Sang
 * 
 * Released on: 3月 3, 2017
 */
    ...
    */
    tools.picker = function (params) {
        ...
        model.find('.bonui-picker__confirm').click(function (e) {
            ...
            if (params.confirm) {
                if (params.confirm.click) params.confirm.click(bonuiPickers,model, e);
            }
            tools.close(model);
        ...
        model.find('.bonui-picker__cancel').click(function (e) {
            ...
            if (params.cancle) {
                if (params.cancle.click) params.cancle.click(bonuiPickers,model, e);
            }
